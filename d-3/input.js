module.exports.testData = `vJrwpWtwJgWrhcsFMMfFFhFp
...
CrZsJsPPZsGzwwsLwLmpwMDw`
    .split(/\n/)
    .map((lineOfInstructions) => {
        return {
            f: lineOfInstructions
                .substring(0, lineOfInstructions.length / 2)
                .split(""),
            s: lineOfInstructions
                .substring(lineOfInstructions.length / 2)
                .split(""),
        };
    });
module.exports.testDataP2 = `vJrwpWtwJgWrhcsFMMfFFhFp
    jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL
    PmmdzqPrVvPwwTWBwg
    wMqvLMZHhHMvwLHjbvcjnnSBnvTQFn
    ttgJtRGJQctTZtZT
    CrZsJsPPZsGzwwsLwLmpwMDw`
    .split(/\n/)
    .map((lineOfInstructions) => lineOfInstructions.trim().split(""));

module.exports.data = `lDDWVvlVVQfDMlWjGJTRjQCgTGLCLj
...
module.exports.dataP2 = `lDDWVvlVVQfDMlWjGJTRjQCgTGLCLj
ZLZpwzLBhwZhSLBsjntGCtgJRjbnJgSG
qppdZzzsdsmZphrNsNwZhllDHLcVVDWFPvFWcWdFlv
ztdhgJDBJghmQtPFQPpmbw
lVlLRcnfllcfVcccGnSQVLcsTPFbpwsPFspTSqmbpswpbF
